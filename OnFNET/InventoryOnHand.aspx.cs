...
public partial class InventoryOnHand : System.Web.UI.Page
{
    ...
    private void GenerateXLS()
    {
        ...
        cells[0, 0].Formula = string.Format("Inventory Snapshot Report for {0}", store.Name);
    ...
    private static string sqlShipCount
        ...
        + "                   and OL.order_suffix = OL.order_suffix	"
        + " where OL.store_id = {0}	"
