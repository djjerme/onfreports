<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderDetailReport.aspx.cs" Inherits="OrderDetailReport" %>
...
<body>
    <form id="FormOrderDetail" runat="server">
        ...
        <table class="tableAlternate" width="95%">
            <tr>
                <td style="width: 3px" valign="top">
                    <asp:Label ID="Label1" runat="server" CssClass="labelNoWrapBold" Text="Order Detail Report"></asp:Label></td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td style="width: 298px; height: 14px" valign="top">
                    <asp:CheckBox ID="CheckBoxSnapshotSync" runat="server" CssClass="tableButton" Text="Synchronize to Snapshots?" /></td>
                <td style="height: 14px" valign="top">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 298px; height: 14px" valign="top">
                    <asp:CheckBox ID="CheckBoxArchive" runat="server" CssClass="tableButton" Text="Use Archive Data?" /></td>
                <td style="height: 14px" valign="top">
                </td>
            </tr>
            <tr>
