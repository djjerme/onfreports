<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JuniperPartReport.aspx.cs" Inherits="JuniperPartReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Juniper Part Report</title>
        ...
        <table class="tableAlternate" width="95%">
            <tr>
                <td style="width: 3px" valign="top">
                    <asp:Label ID="Label1" runat="server" CssClass="labelNoWrapBold" Text="Juniper Part Report"></asp:Label></td>
                <td colspan="2">
            ...
            <tr>
                <td style="width: 3px; height: 14px">
                    <asp:Label ID="Label8" runat="server" CssClass="labelNoWrapBold" Text="Product Super-Department:"></asp:Label></td>
                <td style="height: 14px; width: 298px;">
                    <asp:DropDownList ID="DropDownListSuperDepartment" runat="server" CssClass="tableButton" AppendDataBoundItems="true"
                        DataSourceID="ObjectDataSourceSuperDepartment" OnSelectedIndexChanged="DropDownListSuperDepartment_SelectedIndexChanged"
                        Width="243px" AutoPostBack="True" DataTextField="Name" DataValueField="SuperDeptId">
            ...
            <tr>
                <td style="width: 3px; height: 14px">
                    <asp:Label ID="Label7" runat="server" CssClass="labelNoWrapBold" Text="Product Sub-Department:"></asp:Label></td>
                <td style="height: 14px; width: 298px;">
            ...
            <tr>
                <td style="width: 3px; height: 14px">
                    <asp:Label ID="Label4" runat="server" CssClass="labelNoWrapBold" Text="Include only matched parts:"></asp:Label></td>
                <td style="height: 14px; width: 298px;">
                    <asp:CheckBox runat="server" ID="chkboxOnlyMatchedParts" />    
                </td>
                <td style="height: 14px">
                </td>
            </tr>
    ...
    <asp:Panel runat="server" ID="pnlHTMLReport" Visible="false">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceDepartment" runat="server" SelectMethod="GetDepartmentsAndDefault"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="DropDownListSuperDepartment" Name="superdeptid" PropertyName="SelectedValue"
                    Type="Int32" />
            </SelectParameters>
        </asp:ObjectDataSource>
        
        <asp:ObjectDataSource ID="ObjectDataSourceSuperDepartment" runat="server" SelectMethod="GetSuperDepts"
            TypeName="PBA.OnfBLL.SuperDepartment" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:SessionParameter Name="storeId" SessionField="StoreId" Type="Int32" />
            </SelectParameters>
        </asp:ObjectDataSource>
