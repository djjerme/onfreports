<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConsolidatedFreightReport.aspx.cs" Inherits="ConsolidatedFreightReport" %>
...
<head runat="server">
    <title>Consolidated Freight Report</title>
...
<body>
    ...
    <div id="header">
        <div class="divIndent0">
            <asp:Label ID="Label3" runat="server" CssClass="labelNoWrapBold" Text="Consolidated Freight Report"></asp:Label>
        </div>
    ...
    <div id="main" >
        ...
        <div class="divBand" style="height: 39px; left: 0px; top: 0px;"><div class="divIndent1">
            <asp:Label ID="Label2" runat="server">Select Carrier:</asp:Label>
        </div>
            <div class="divIndent3">
                <asp:DropDownList ID="DropDownListCarrier" runat="server" CssClass="tableButton"
                    DataSourceID="ObjectDataSourceCarrier" DataTextField="CarrierCode" DataValueField="CarrierId"
                    Width="173px">
        ...
        <asp:ObjectDataSource ID="ObjectDataSourceCarrier" runat="server" SelectMethod="GetCarrierList"
            TypeName="PBA.OnfList.CarrierList"></asp:ObjectDataSource>
    </ContentTemplate>
        <Triggers>
