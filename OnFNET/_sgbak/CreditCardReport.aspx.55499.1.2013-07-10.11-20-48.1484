<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreditCardReport.aspx.cs" Inherits="CreditCardReport" %>
...
<body>
    ...
    <div id="header">
        <div class="divIndent0">
            <asp:Label ID="Label3" runat="server" CssClass="labelNoWrapBold" Text="Credit Card Report"></asp:Label>
        </div>
    ...
    <div id="main" >
        ...
        <div class="divBand" style="height: 39px; left: 0px; top: 0px;">
            <div class="divIndent0">
                <asp:Label ID="Label4" runat="server" Text="Ship Date Range:" CssClass="labelNoWrapBold"></asp:Label>
            </div>        
        </div>
