<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JuniperPODReport.aspx.cs" Inherits="JuniperPODReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Juniper POD Report</title>
        ...
        <table class="tableAlternate" width="95%">
            <tr>
                <td style="width: 3px" valign="top">
                    <asp:Label ID="Label1" runat="server" CssClass="labelNoWrapBold" Text="Juniper POD Report"></asp:Label></td>
                <td colspan="2">
