<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransactionSummary.aspx.cs" Inherits="TransactionSummary" %>
        ...
        <table class="tableAlternate" width="95%">
            <tr>
                <td class="labelNoWrapBold" style="width: 178px" valign="top">
                    <asp:Label ID="Label1" runat="server" Text="Transaction Summary Report"></asp:Label></td>
